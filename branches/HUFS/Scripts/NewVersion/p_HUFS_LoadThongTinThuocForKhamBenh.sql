...
BEGIN
	...
	INNER JOIN HUFS_CHINHSACH_HEADER ON HUFS_CHINHSACH_DETAIL.MaChinhSachGia = HUFS_CHINHSACH_HEADER.MaChinhSachGia
	...
	WHERE HUFS_CHINHSACH_DETAIL.IsDeleted = 0
	     AND GETDATE() BETWEEN HUFS_CHINHSACH_HEADER.ThoiGianBatDau AND HUFS_CHINHSACH_HEADER.NgayNgungHoatDong
