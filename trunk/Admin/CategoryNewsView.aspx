...
CodeFile="CategoryNewsView.aspx.cs" Inherits="Admin_CategoryNewsView" %>
...
<asp:GridView ID="GridCategoryNews" runat="server" Width="100%" BackColor="White"
...
CssClass="gridview" ShowFooter="false" AllowPaging="True" AllowSorting="True" 
        PageSize="30" onpageindexchanging="GridCategoryNews_PageIndexChanging" >
...
<ItemTemplate>
<asp:Label runat="server" ID="lblId" Text='<%#Eval("Name") %> '></asp:Label>
</ItemTemplate>
<ItemStyle Width="6%" />
</asp:TemplateField>
...
<ItemTemplate>
<asp:LinkButton runat="server" ID="btnEdit" Text="Edit" CommandName=""></asp:LinkButton> | 
<asp:LinkButton runat="server" ID="btnView" Text="View" CommandName=""></asp:LinkButton>
</ItemTemplate>
<ItemStyle Width="6%" />
